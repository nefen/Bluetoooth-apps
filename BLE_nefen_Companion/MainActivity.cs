    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        */
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            //}
            /// I do not know...
            //0StartActivity(new Intent(BluetoothAdapter.ActionRequestEnable));
            ...
            //0var intent = new Intent(this, typeof(BleReceiver));

            //0var pendingIntent = PendingIntent.GetBroadcast(this, 111, intent, PendingIntentFlags.UpdateCurrent);// | PendingIntentFlags.Mutable);
            ...
            scanButton.Click += delegate
            {
                ...
                var AssociationRequest = AssociationRequest.Builder().build();
                ...
                if (_isScanning || bleAdapter.IsDiscovering)
                {
                    ...
                    {
                        bleAdapter.BluetoothLeScanner.StopScan(newCallback);// pendingIntent);
                    }
                    else
...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                else
                {
                    ...
                    if (Build.VERSION.SdkInt >= BuildVersionCodes.O)
                    {
                        ...
                        //                            .Build();
                        //filters.Add(filter);
                        String[] names = new String[] { "L1250 Series"/*, "Nordic_LBS" */};
                        if (names != null)
                        {
